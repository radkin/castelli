...
curl -X POST -d "release=${release}&artifacts_urls=${artifacts_urls}&job_name=${upload_job_name}&job_url=${upload_build_url}" -H "Content-Type: application/x-www-form-urlencoded" http://castelli-host.example.com:3000/api/jenkins
